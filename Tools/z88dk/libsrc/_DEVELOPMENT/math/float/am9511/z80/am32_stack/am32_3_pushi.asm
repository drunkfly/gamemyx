...
;
;-------------------------------------------------------------------------
;  asm_am9511_3_pushi - am9511 APU push integer
;-------------------------------------------------------------------------
; 
...
PUBLIC asm_am9511_3_pushi_hl
PUBLIC asm_am9511_3_pushi_fastcall

.am9511_3_pushi_hl_wait
    ex (sp),hl
    ex (sp),hl

.asm_am9511_3_pushi_hl
...
.am9511_3_pushi_fastcall_wait
    ex (sp),hl
    ex (sp),hl

.asm_am9511_3_pushi_fastcall
    ...
    in a,(__IO_APU3_STATUS)     ; read the APU status register
    rlca                        ; busy? __IO_APU_STATUS_BUSY
    jr C,am9511_3_pushi_fastcall_wait
