...
;
;-------------------------------------------------------------------------
;  asm_am9511_1_popi - am9511 APU pop integer
;-------------------------------------------------------------------------
; 
...
PUBLIC asm_am9511_1_popi_hl
PUBLIC asm_am9511_1_popi

.am9511_1_popi_hl_wait
    ex (sp),hl
    ex (sp),hl
    
.asm_am9511_1_popi_hl
