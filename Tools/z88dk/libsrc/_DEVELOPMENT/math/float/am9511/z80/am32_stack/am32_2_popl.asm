...
;
;-------------------------------------------------------------------------
;  asm_am9511_2_popl - am9511 APU pop long
;-------------------------------------------------------------------------
; 
...
PUBLIC asm_am9511_2_popl_hl
PUBLIC asm_am9511_2_popl

.am9511_2_popl_hl_wait
    ex (sp),hl
    ex (sp),hl
    
.asm_am9511_2_popl_hl
