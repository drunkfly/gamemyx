...
;
;-------------------------------------------------------------------------
;  asm_am9511_1_pushl - am9511 APU push long
;-------------------------------------------------------------------------
; 
...
PUBLIC asm_am9511_1_pushl_hl
PUBLIC asm_am9511_1_pushl_fastcall

.am9511_1_pushl_hl_wait
    ex (sp),hl
    ex (sp),hl

.asm_am9511_1_pushl_hl
...
.am9511_1_pushl_fastcall_wait
    ex (sp),hl
    ex (sp),hl

.asm_am9511_1_pushl_fastcall
    ...
    in a,(__IO_APU1_STATUS)     ; read the APU status register
    rlca                        ; busy? __IO_APU_STATUS_BUSY
    jr C,am9511_1_pushl_fastcall_wait
