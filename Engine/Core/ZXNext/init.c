...
void MYXP_PlatformInit()
{
    ...
    NEXT_SETREG(NEXT_CLIP_WINDOW_TILEMAP, 32/2);        // X1
    NEXT_SETREG(NEXT_CLIP_WINDOW_TILEMAP, (32+256-1)/2);// X2
    NEXT_SETREG(NEXT_CLIP_WINDOW_TILEMAP, 32);          // Y1
    NEXT_SETREG(NEXT_CLIP_WINDOW_TILEMAP, (32+192-1));  // Y2
}
